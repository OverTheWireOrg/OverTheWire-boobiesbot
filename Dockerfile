...
CMD git clone https://github.com/StevenVanAcker/OverTheWire-boobiesbot.git && git checkout v2.0 && cd /data && /home/boobiesbot/OverTheWire-boobiesbot/boobiesbot.py $HOSTIP
